...
class OystHookDisplayProductButtonsProcessor extends FroggyHookProcessor
{
    public function run()
    {
        ...
        if (Tools::getValue('content_only')) {
            if ($oneClickActivated && !Configuration::get('FC_OYST_ACTIVE_BTN_QV')) {
                $oneClickActivated = false;
            }
            $widthBtn = Configuration::get('FC_OYST_WIDTH_BTN_QV');
            $heightBtn = Configuration::get('FC_OYST_HEIGHT_BTN_QV');
            $marginTopBtn = Configuration::get('FC_OYST_MARGIN_TOP_BTN_QV');
            $marginLeftBtn = Configuration::get('FC_OYST_MARGIN_LEFT_BTN_QV');
            $marginRightBtn = Configuration::get('FC_OYST_MARGIN_RIGHT_BTN_QV');
            $positionBtn = Configuration::get('FC_OYST_POSITION_BTN_QV');
        } else {
        ...
        $this->smarty->assign(array(
            ...
            'oneClickActivated' => $oneClickActivated,
        ...
        return $this->module->fcdisplay(__FILE__, 'displayProductButtons.tpl');
    }
}
