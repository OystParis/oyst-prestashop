 ...
 */
class OystHookActionObjectCombinationUpdateAfterProcessor extends FroggyHookProcessor
{
    /**
     * @return bool
     */
    public function run()
    {
        ...
        if (!$succeed) {
            $this->context->controller->errors[] = 'Can\'t synchronise product to oyst (while combination update product):';
