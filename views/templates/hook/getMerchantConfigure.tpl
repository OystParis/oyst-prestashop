    ...
    <form id="module_form" class="defaultForm form-horizontal" method="POST" action="#">
        ...
        <fieldset id="oyst_fieldset">
            ...
            <div class="margin-form" style="padding-left:15px">
                ...
                <p><b>{l s='Set the Oyst check endpoint' mod='oyst'}</label></b></p>
                <div class="margin-form" style="padding-left:15px"><input type="text" id="FC_OYST_API_CHECK_ENDPOINT" name="FC_OYST_API_CHECK_ENDPOINT" value="{$oyst.FC_OYST_API_CHECK_ENDPOINT|escape:'htmlall':'UTF-8'}" style="width:400px" /></div>
        ...
        <fieldset id="oyst_fieldset">
            ...
            <div class="margin-form" style="padding-left:15px">
                ...
                <div class="margin-form" style="padding-left:15px"><input type="text" id="FC_OYST_API_ENDPOINT" name="FC_OYST_API_ENDPOINT" value="{$oyst.FC_OYST_API_ENDPOINT|escape:'htmlall':'UTF-8'}" style="width:400px" /></div>
                <br><p><input type="submit" name="submitOystConfiguration" value="{l s='Save' mod='oyst'}" name="oyst_ft_form" class="button" /></p>
            </div>
        </fieldset>
        ...
        <fieldset id="oyst_fieldset">
            <legend><img src="{$oyst.module_dir|escape:'html':'UTF-8'}logo.png" alt="" width="16" />{l s='Catalog feature' mod='oyst'}</legend>
