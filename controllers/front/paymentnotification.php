...
class OystPaymentNotificationModuleFrontController extends ModuleFrontController
{
            ...
            if ($notification_item['success'] == 1) {
                switch ($notification_item['event_code']) {
                    ...
                    case OystPaymentNotification::EVENT_AUTHORISATION:
                        $this->convertCartToOrder($notification_item, Tools::getValue('ch'), $event_data, $notification_item);
                        break;
    ...
    public function convertCartToOrder($payment_notification, $url_cart_hash, $event_data, $notification_item)
    {
        // Load cart
